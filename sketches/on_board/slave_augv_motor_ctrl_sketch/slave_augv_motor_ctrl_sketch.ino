...
// @TODO - change to incorporate different left and right wheel sizes.
// @TODO - convert back to the reference distance that ROS thinks the wheel has traversed.
...
void requestEvent() {
  ...
  write_float_to_bytes(-steps_to_ros_angle(leftStepper.currentPosition()));
  write_float_to_bytes(steps_to_ros_angle(rightStepper.currentPosition()));
}
